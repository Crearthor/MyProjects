...
class SurveyController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $creationSes = new Container('creation');
        $creationSes->getManager()->getStorage()->clear('creation');
        $resultses = new Container('result');
        $resultses->getManager()->getStorage()->clear('result');
    ...
    public function createAction()
    {
        ...
        if (((isset($_POST['submitdq']) && $session->offsetGet('nquestion') > 0) || (isset($_POST['submitpq']) && $session->offsetGet('nquestion') > 1) && $valid == 1) && $session->offsetGet('AllQ') >= 1) {
        ...
        $form->get('submit')->setValue('Save Survey');
